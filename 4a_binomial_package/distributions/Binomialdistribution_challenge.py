...
class Binomial(Distribution):
    ...
    # NOTE TO SELF: Remember you need to initialize the parent class as well!
    ...
    # a distribution. Hence you are going to write a method that s n, p, mean and
    ...
    def replace_stats_with_data(self):
        ...
        """
        # self.data should already be stored correctly, assumedly....
        
        # update p and n
        self.n = len(self.data)
        self.p = np.sum(self.data) / self.n
        
        # given p and n, update self.mean and self.stdev
    ...
    # MY NOTE: This should say probability MASS function. Not "density" 
    def pdf(self, k):
    ...
    def plot_pdf(self):
        ...
        for k in range(self.n):
            values.append(self.pdf(k))
            
        plt.bar(values)
        plt.title("Plotting the PDF of the Binomial Distribution")
        plt.xlabel("Values")
        plt.ylabel("Probability")
        plt.show()
